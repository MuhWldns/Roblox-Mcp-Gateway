...
export default function Privacy() {
  return (
    <LegalLayout
      ...
      description="How Buildly by RBX collects, uses, protects, and gives you control over information used to connect your AI client to Studio."
    >
      <section>
        <h2>1. Who we are</h2>
        <p>
          Buildly by RBX operates the Buildly gateway, dashboard, and desktop companion. Buildly is an independent service and is not affiliated with, endorsed by, or sponsored by Roblox Corporation, OpenAI, or Anthropic.
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          Buildly stores digests of service-issued credentials and tokens rather than their plaintext values. Account, device, session, and connector credentials remain separate and are not interchangeable.
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          Buildly uses secure, host-only cookies for authentication and cross-site request forgery protection. Authentication cookies are marked Secure and HttpOnly. The service does not place device credentials, connector tokens, or third-party provider tokens in browser local storage.
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          Information is disclosed only as needed to operate the service, comply with law, protect users and the service, or complete an action you request. This can include account authentication providers, your selected AI client for the connector flow, and infrastructure providers that host or transport Buildly data.
        </p>
        <p>
          Your tool requests and responses travel through Buildly to the companion bridge on your selected device. The companion communicates locally with the official Studio MCP. Your use of Studio, ChatGPT, Claude, and other third-party services is also governed by those providers' policies.
        </p>
      </section>
      ...
      <section>
        <h2>7. Security</h2>
        <p>
          Buildly uses encrypted transport, restricted cookies, hashed or keyed credential storage, bounded access, revocation controls, rate limiting, and audit records. The companion protects its device credential using Windows data protection. No system is completely secure, so you should promptly report suspected compromise and revoke affected devices or connectors.
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          Buildly and its infrastructure providers may process information in countries other than your own. Buildly is not directed to children below the minimum age required to consent to online services in their jurisdiction. A parent or guardian who believes a child provided information without appropriate permission should contact us.
        </p>
      </section>
      ...
      <section>
        <h2>11. Contact</h2>
        <p>
          Contact Buildly by RBX using the address shown on this page. By using Buildly, you also agree to the <Link to="/terms">Terms of Service</Link>.
        </p>
      </section>
    </LegalLayout>
  );
